 ...
 * @author pep
 */
public class CuentaCorrienteTest1 {

    private CuentaCorriente instance;

    public CuentaCorrienteTest1() {
    }

    /* Aquest mètode s'executa abans de tot */
    @BeforeClass
    public static void setUpClass() {
        System.out.println("Iniciando tests 1 ...");
    }

    /* Aquest mètode s'executa al final de tot */
    @AfterClass
    public static void tearDownClass() {
        System.out.println("Acabando tests 1 ...");
    }
    ...
    @Test(timeout = 100)
    // @Ignore("Already checked")
    public void testIngresa2() throws Exception {
        instance.ingresa(100.0);
        assertEquals(100.0, instance.getSaldo(), 1.0E-3);
    }
